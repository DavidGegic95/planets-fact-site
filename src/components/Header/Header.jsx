...
const Header = ({ mercuryRef1, venusRef1, earthRef1, marsRef1, saturnRef1, jupiterRef1, uranusRef1, neptuneRef1, planetState }) => {
    const changeNeptune = () => {
    ...
    return (
        <div className='header-wrapper'>
            <header>
                <Link className='header-home-button' to='/' >THE PLANETS</Link>
                <MenuMobile />
                <nav className='none-mobile-nav'>
                    <div
                        ...
                        <div className={`mercury-line ${planetState === 'mercury' ? 'mercury-line-hover' : ''}`}></div>
                    ...
                    <div
                        ...
                        <div className={`venus-line ${planetState === 'venus' ? 'venus-line-hover' : ''}`}></div>
                    ...
                    <div
                        ...
                        <div className={`earth-line ${planetState === 'earth' ? 'earth-line-hover' : ''}`}></div>
                    ...
                    <div
                        ...
                        <div className={`mars-line ${planetState === 'mars' ? 'mars-line-hover' : ''}`}></div>
                    ...
                    <div
                        ...
                        <div className={`jupiter-line ${planetState === 'jupiter' ? 'jupiter-line-hover' : ''}`}></div>
                    ...
                    <div
                        ...
                        <div className={`saturn-line ${planetState === 'saturn' ? 'saturn-line-hover' : ''}`}></div>
                    ...
                    <div
                        ...
                        <div className={`uranus-line ${planetState === 'uranus' ? 'uranus-line-hover' : ''}`}></div>
                        <Link to='/uranus'>URANUS</Link>
                    </div>
                    <div
                        onMouseLeave={changeBackNeptune}
                        onMouseOver={changeNeptune} className='neptune-header-div'>
                        <div className={`neptune-line ${planetState === 'neptune' ? 'neptune-line-hover' : ''}`}></div>

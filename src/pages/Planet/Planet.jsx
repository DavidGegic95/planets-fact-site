...
const Planet = ({ setPlanetState }) => {
  ...
  function butttonFocus1() {
    return view === "planet" ? `button-focus-${planet}` : "";
  }
  function butttonFocus2() {
    return view === "internal" ? `button-focus-${planet}` : "";
  }
  function butttonFocus3() {
    return view === "geology" ? `button-focus-${planet}` : "";
  }
      ...
      <div className="grid">
        <motion.div
          ...
          initial={{
            ...
            x: 0,
            scale: 0,
            transition: { duration: 2, delay: 2.2, to: 0 },
            rotate: 360,
          }}
          animate={{
            opacity: 1,
        ...
        >
          <section className="section-planet">
            <div className="h1&&text">
              ...
              <AnimatePresence>
                {view === "planet" && (
                  <>
                    <TextContent
                      currentPlanetObject={currentPlanetObject}
                      view={view}
                    />
                    ...
                    <div className="wikipedia-div">
                      ...
                      <a
                        ...
                        target={"_blank"}
                        rel={"noreferrer"}
                        href={currentPlanetObject.overview.source}
                      >
                        Wikipedia
                        <YourSvg />
                      </a>
                  ...
                  <>
                    ...
                    <div className="wikipedia-div">
                      ...
                      <a
                        ...
                        target={"_blank"}
                        rel={"noreferrer"}
                        href={currentPlanetObject.structure.source}
                      >
                        Wikipedia
                        <YourSvg />
                      </a>
                  ...
                  <>
                    ...
                    <div className="wikipedia-div">
                      ...
                      <a
                        ...
                        target={"_blank"}
                        rel={"noreferrer"}
                        href={currentPlanetObject.geology.source}
                      >
                        Wikipedia
                        <YourSvg />
                      </a>
            ...
            <div className="buttons-section">
              <button
                onClick={() => setView("planet") || setIsClicked(true)}
                className={`button1 ${butttonFocus1()}`}
              >
                <span className="button-numbers">01</span> OVERVIEW
              </button>
              <button
                onClick={() => setView("internal") || setIsClicked(true)}
                className={`button2 ${butttonFocus2()}`}
              >
                <span className="button-numbers">02</span>INTERNAL STRUCTURE
              </button>
              <button
                onClick={() => setView("geology") || setIsClicked(true)}
                className={`button3 ${butttonFocus3()}`}
              >
                <span className="button-numbers">03</span>SURFACE GEOLOGY
              </button>
            </div>
          </section>
        </motion.div>
